package com.example.facialexpression.classifiers;

import android.content.res.AssetManager;
import android.graphics.Bitmap;

import com.example.facialexpression.classifiers.behaviors.TFLiteImageClassification;
...
public class TFLiteImageClassifier extends TFLiteClassifier {
    ...
    private float[] preprocessImage(Bitmap imageBitmap, boolean useFilter) {
        ...
        int[] greyScaleImage = Image.toGreyScale(scaledImage);
