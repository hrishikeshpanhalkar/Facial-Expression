...
import com.example.facialexpression.customview.OverlayView;
import com.example.facialexpression.deepmodel.DetectionResult;
import com.example.facialexpression.deepmodel.MobileNetObjDetector;
import com.example.facialexpression.utils.ImageUtils;

import java.io.IOException;
import java.util.List;

public class ObjectActivity extends CameraActivity implements OnImageAvailableListener {
    private static int MODEL_IMAGE_INPUT_SIZE = 300;
    private static String LOGGING_TAG = SplashActivity.class.getName();
